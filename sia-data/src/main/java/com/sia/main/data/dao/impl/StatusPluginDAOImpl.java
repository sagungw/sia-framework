...
public class StatusPluginDAOImpl implements StatusPluginDAO {
	...
	private static final Logger logger = LoggerFactory.getLogger(StatusPluginDAOImpl.class);
	...
	@Override
	public void insert(StatusPlugin statusPlugin) {
	...
	@Override
	public void update(StatusPlugin statusPlugin) {
		final Session session = this.getSession();
		try{
			final Transaction transaction = session.beginTransaction();
			try {
	...
	@Override
	public void delete(StatusPlugin statusPlugin) {
		final Session session = this.getSession();
		try{
			final Transaction transaction = session.beginTransaction();
			try {
